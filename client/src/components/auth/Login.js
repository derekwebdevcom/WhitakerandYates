        ...
        <div className="row no-pad">
          <div className="col-md-6 offset-md-3">
            <Link to="/" className="btn-flat waves-effect">
              <i className="material-icons col-md-6">keyboard_backspace</i> Back
            </Link>
            <Link to="/register" className="text-center">
              <button className="btn btn-warning ml-4 mr-4">Register</button>
            </Link>
            <div className="col-md-6 offset-md-3">
              <h4>
                <b className="mt-3 mb-5">Login</b> below
              </h4>
            </div>
